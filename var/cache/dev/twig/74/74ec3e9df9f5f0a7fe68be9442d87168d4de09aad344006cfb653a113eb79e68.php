...
class __TwigTemplate_09e1944ee3d04fef855ff776c30bc31a8cb2ed0521005b7da852339cb350a65c extends Template
{
    private $source;
    private $macros = [];
...
";
        ...
        echo "\" name=\"username\" id=\"inputUsername\" class=\"form-control\" placeholder=\"Username\" autocomplete=\"username\" required autofocus>
                </div>
                <div>
";
        // line 19
        echo "                    <input type=\"password\" name=\"password\" id=\"inputPassword\" class=\"form-control\" placeholder=\"Password\" autocomplete=\"current-password\" required>
                </div>
                <div>
...
";
    ...
    {
        return array (  158 => 22,  153 => 19,  146 => 15,  142 => 12,  136 => 11,  131 => 8,  121 => 7,  103 => 6,  90 => 4,  80 => 3,  61 => 2,  38 => 1,);
    }
...
<form class=\"form\" method=\"post\">
        <div class=\"formContainer\">
            <div class=\"formBody\">
                {% if error %}<div class=\"alert alert-danger\">{{ error.messageKey|trans(error.messageData, 'security') }}</div>{% endif %}
                <p>Login</p>
                <div>
...
", "security/login.html.twig", "/Users/MacOSX/Desktop/TWA-SEMESTRAL/twa-semestral/templates/security/login.html.twig");
    }
}
